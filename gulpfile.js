...
gulp.task('copy-workerscripts', function() {
  return gulp.src('app/js/jsqrcode/*.js')
...
gulp.task('audio', function() {
  return gulp.src(['app/media/audio/**'])
...
gulp.task('serve', ['styles'], function() {
  ...
  gulp.watch(['app/js/**/*.js','app/styleguide/**/*.js'], ['jshint']);
  gulp.watch(['app/media/images/**/*'], reload);
});
...
gulp.task('default', ['clean'], function(cb) {
  runSequence('css', ['html', 'js', 'css', 'media', 'fonts', 'copy', 'copy-workerscripts'], cb);
});
